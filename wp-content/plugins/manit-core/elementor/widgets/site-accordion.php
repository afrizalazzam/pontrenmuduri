<?php
/*
 * Elementor Manit Accordion  Widget
...
class Manit_Accordion  extends Widget_Base
{
	...
	{
		return esc_html__('Accordion ', 'manit-core');
	}
	...
	/**
	 * Retrieve the list of scripts the Manit Accordion  widget depended on.
	...
	/**
	 * Register Manit Accordion  widget controls.
	...
	protected function register_controls()
	{
		...
		$this->start_controls_section(
			'section_accordion',
			[
				'label' => esc_html__('Accordion  Options', 'manit-core'),
			]
		);
		...
		$repeater->add_control(
			'active_tabs',
			[
				'label' => __('Active Accordion', 'manit-core'),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Accordion  Items', 'manit-core'),
				'type' => Controls_Manager::REPEATER,
				'default' => [
					[
						'accordion_title' => esc_html__('Accordion ', 'manit-core'),
					],
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Accordion Content', 'manit-core'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_group_control(
			...
			[
				'label' => esc_html__('Typography', 'manit-core'),
				'name' => 'manit_accordion_content_typography',
...
Plugin::instance()->widgets_manager->register(new Manit_Accordion());
