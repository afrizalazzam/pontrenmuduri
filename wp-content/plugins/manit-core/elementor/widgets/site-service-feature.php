<?php
/*
 * Elementor Manit ServiceItem Widget
...
class Site_ServiceItem extends Widget_Base
{
	...
	{
		return esc_html__('Service Feature', 'manit-core');
	}
	...
	/**
	 * Retrieve the list of scripts the Manit ServiceItem widget depended on.
	...
	*/
	...
	/**
	 * Register Manit ServiceItem widget controls.
	...
	protected function register_controls()
	{
		...
		$this->start_controls_section(
			'section_ServiceItem',
			[
				'label' => esc_html__('ServiceItem Options', 'manit-core'),
			]
		);
...
Plugin::instance()->widgets_manager->register(new Site_ServiceItem());
