 ...
 */
class manit_footer_posts extends WP_Widget {
  ...
  public function __construct() {
    parent::__construct(
      '-footer-blog',
      MANIT_THEME_NAME_PLUGIN . esc_html__( ': Footer Posts', 'manit' ),
      array(
        'classname'   => 'footer-post-widget',
        'description' => MANIT_THEME_NAME_PLUGIN . esc_html__( ' widget that displays footer posts.', 'manit' )
      )
    );
  }
  ...
  public function form( $instance ) {
    ...
    $instance   = wp_parse_args( $instance, array(
      'title'    => esc_html__( 'Footer Posts', 'manit' ),
      'ptypes'   => 'post',
      'limit'    => '3',
      'date'     => true,
      'category' => '',
...
add_action( 'widgets_init', function() { register_widget( "manit_footer_posts" ); } );