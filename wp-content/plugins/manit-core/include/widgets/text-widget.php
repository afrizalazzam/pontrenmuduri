 ...
 */
class manit_text_widget extends WP_Widget {
  ...
  public function __construct() {
    parent::__construct(
      'text-widget',
      MANIT_THEME_NAME_PLUGIN . esc_html__( ': Text Widget', 'manit' ),
      array(
        'classname'   => 'text-widget',
        'description' => MANIT_THEME_NAME_PLUGIN . esc_html__( ' widget that displays contents.', 'manit' )
      )
    );
  }
...
add_action( 'widgets_init', function() { register_widget( "manit_text_widget" ); } );