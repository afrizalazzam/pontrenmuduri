/*
 * All Admin Related Scripts in this Manit Theme
...
"use strict";
  ...
  /*---------------------------------------------------------------*/
   function manit_gutenberg_toggle_metaboxes() {
  ...
  function manit_toggle_metaboxes() {
  ...
  $(document).ready(function() {
      manit_gutenberg_toggle_metaboxes();
      manit_toggle_metaboxes();
    $('#post-formats-select input[type="radio"]').on('click', manit_toggle_metaboxes);
  });
