(function($) {
    ...
    function smallNavFunctionality() {
        ...
        var menuItemWithSubMenu = smallNav.find(".menu-item-has-children > a > i");

        if (windowWidth <= 991) {
            subMenu.hide();
            megamenu.hide();
            menuItemWithSubMenu.on("click", function(e) {
                var $this = $(this);
...
/*------------------------------------------
    ...
    $('.blog-sidebar .wp-block-search .wp-block-search__label').append('<h2>Search</h2>');
     ...
     $('.wpo-site-header .navigation .menu-item-has-children > a').append('<i class="ti-angle-right"></i>');
