...
if ( ! function_exists( 'manit_widget_init' ) ) {
	function manit_widget_init() {
		if ( function_exists( 'register_sidebar' ) ) {

			// Main Widget Area
			register_sidebar(
				array(
					'name' => esc_html__( 'Main Widget Area', 'manit' ),
					'id' => 'sidebar-1',
					'description' => esc_html__( 'Appears on posts and pages.', 'manit' ),
	    ...
	    if( $footer_widgets ) {
	      ...
	      for( $i = 0; $i < $length; $i++ ) {
	        ...
	        register_sidebar( array(
	          'id'            => 'footer-' . $num,
	          'name'          => esc_html__( 'Footer Widget ', 'manit' ). $num,
	          'description'   => esc_html__( 'Appears on footer section.', 'manit' ),
	...
	add_action( 'widgets_init', 'manit_widget_init' );
}