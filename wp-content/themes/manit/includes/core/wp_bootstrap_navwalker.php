<?php
/**
 * Class Name: manit_wp_bootstrap_navwalker
...
class manit_wp_bootstrap_navwalker extends Walker_Nav_Menu {
	...
	public static function fallback( $args ) {
		if ( current_user_can( 'manage_options' ) ) {
			...
			$fb_output .= '>';
			$fb_output .= '<li><a href="' . admin_url( 'nav-menus.php' ) . '">'.esc_html__( 'Add a menu','manit' ).'</a></li>';
			$fb_output .= '</ul>';
