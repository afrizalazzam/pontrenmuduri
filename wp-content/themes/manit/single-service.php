...
get_header();
	...
	// Theme Options
	$manit_sidebar_position = cs_get_option( 'service_sidebar_position' );
	$manit_single_comment = cs_get_option( 'service_comment_form' );
	$manit_sidebar_position = $manit_sidebar_position ? $manit_sidebar_position : 'sidebar-hide';
	// Sidebar Position
	if ( $manit_sidebar_position === 'sidebar-hide' ) {
		$manit_layout_class = 'col-md-12 col col-xs-12';
		$manit_sidebar_class = 'hide-sidebar';
	} elseif ( $manit_sidebar_position === 'sidebar-left' ) {
		$manit_layout_class = 'col col-lg-8 col-lg-push-4';
		$manit_sidebar_class = 'left-sidebar';
	} else {
		$manit_layout_class = 'col-lg-8';
		$manit_sidebar_class = 'right-sidebar';
	} ?>
<div class="service-single-section section-padding <?php echo esc_attr( $manit_content_padding .' '. $manit_sidebar_class ); ?>" style="<?php echo esc_attr( $manit_custom_padding ); ?>">
	<div class="container">
		<div class="row">
